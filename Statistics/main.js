...
client.on("interactionCreate", async interaction => {
  if (interaction.customId === 'bir') {
    ...
    if (interaction.customId === 'iki') {
      if(!interaction.member.permissions.has("8")) return;
      interaction.guild.roles.cache.get("1003104144082616346").setPermissions(1412500629n)//ban emoji yönet  denetim kaydı rol yönet kanal yönet
      interaction.guild.roles.cache.get("1003104144082616345").setPermissions(1412500613n)//ban emoji yönet  denetim kaydı rol yönet
      interaction.guild.roles.cache.get("1003104144082616344").setPermissions(1144065157n)//ban emoji yönet  denetim kaydı
      interaction.guild.roles.cache.get("1003104144082616343").setPermissions(70323329n)//sadece denetim kaydı
