...
.setTimestamp()
.setDescription(`${entry.executor} (**${entry.executor.id}**) üyesi __**${moment(Date.now()).format('LLL')}**__ tarihinde \`${channel.name}\` (**${channel.id}**) isminde bir kanal **oluşturdu.**\`\`\`js
